		...
		<div class="account-settings">
			<div class="user-profile">
				<div class="user-avatar">
					<img src="./admin_area/user_image/<?php echo $user['user_image']?>" alt="Maxwell Admin">
...
$sql="UPDATE users set  user_name='$user_name', user_email='$user_email', user_country='$user_country' ,user_address='$user_address' , user_phone='$user_phone',user_image='$image' where user_id='$id'";
